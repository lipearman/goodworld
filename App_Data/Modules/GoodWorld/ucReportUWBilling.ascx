<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReportUWBilling.ascx.vb" Inherits="Modules_ucReportUWBilling" %>
<fieldset>
...
<asp:SqlDataSource ID="SqlDataSource_Year" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    SelectCommand="SELECT distinct  PaymentYear  FROM  v_Report_UWBilling_Summary order by PaymentYear desc"></asp:SqlDataSource>
...
<dx:BootstrapFormLayout ID="BootstrapFormLayout1" runat="server" ClientInstanceName="frmEnquiry" LayoutType="Horizontal">
    <Items>
        <dx:BootstrapLayoutItem Caption="ประจำปี" ColSpanLg="4" ColSpanSm="4">
            <ContentCollection>
                <dx:ContentControl>
                    <dx:BootstrapComboBox runat="server" ID="PaymentYear"
                        DataSourceID="SqlDataSource_Year" TextField="PaymentYear" ValueField="PaymentYear"
...
<dx:BootstrapGridView ID="TaskGrid" runat="server"
    ...
    KeyFieldName="InsurerCode" SettingsBehavior-AllowDragDrop="false"
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    SelectCommand="select * from v_Report_UWBilling_Summary where PaymentYear=@PaymentYear">
    <SelectParameters>
        <asp:SessionParameter Name="PaymentYear" SessionField="PaymentYear" />
    </SelectParameters>
...
<dx:ASPxPopupControl ID="TaskEditPopup" ClientInstanceName="TaskEditPopup" runat="server"
    ShowHeader="true" CloseOnEscape="false" CloseAction="CloseButton" HeaderText="รายละเอียดการจ่ายของแต่ละบริษัทประกันภัย"
...
<asp:SqlDataSource ID="SqlDataSource_Details" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    ...
    <SelectParameters>
        <asp:SessionParameter Name="PaymentYear" SessionField="PaymentYear" />
        <asp:SessionParameter Name="InsurerCode" SessionField="InsurerCode" />
    </SelectParameters>
