...
Partial Class Modules_ucPolicyTypeSetup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        SqlDataSource_PolicyType.InsertParameters("UserName").DefaultValue = HttpContext.Current.User.Identity.Name
        SqlDataSource_PolicyType.UpdateParameters("UserName").DefaultValue = HttpContext.Current.User.Identity.Name
    ...
    Protected Sub TaskGrid_RowInserting(ByVal sender As Object, ByVal e As DevExpress.Web.Data.ASPxDataInsertingEventArgs) Handles TaskGrid.RowInserting
        ...
        Using dc As New DataClasses_GoodWorldExt()
            Dim data = dc.tblPolicyTypes.SingleOrDefault(Function(c) c.Code.Equals(Code))
    ...
    Protected Sub TaskGrid_RowUpdating(ByVal sender As Object, ByVal e As DevExpress.Web.Data.ASPxDataUpdatingEventArgs) Handles TaskGrid.RowUpdating
        ...
        Dim Code = e.NewValues("Code").ToString()
        Using dc As New DataClasses_GoodWorldExt()
            Dim data = dc.tblPolicyTypes.SingleOrDefault(Function(c) c.Code.Equals(Code) And c.ID <> ID)
            If data IsNot Nothing Then
