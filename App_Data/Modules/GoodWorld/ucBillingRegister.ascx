...
ลงวันที่--%>
        ...
        <dx:BootstrapGridViewTextColumn Caption="เลขที่"></dx:BootstrapGridViewTextColumn>
        ...
        <dx:BootstrapGridViewSpinEditColumn FieldName="PRCommP" Caption="ส่วนลด" PropertiesSpinEdit-NumberType="Float" PropertiesSpinEdit-DisplayFormatString="{0:N2}"></dx:BootstrapGridViewSpinEditColumn>
        <dx:BootstrapGridViewSpinEditColumn FieldName="PRCommAmt" Caption="ส่วนลด" PropertiesSpinEdit-NumberType="Float" PropertiesSpinEdit-DisplayFormatString="{0:N2}"></dx:BootstrapGridViewSpinEditColumn>
        <dx:BootstrapGridViewSpinEditColumn FieldName="GrossPremium" Caption="เบี้ยสุทธิ" PropertiesSpinEdit-NumberType="Float" PropertiesSpinEdit-DisplayFormatString="{0:N2}"></dx:BootstrapGridViewSpinEditColumn>


        <dx:BootstrapGridViewDateColumn FieldName="CreateDate" Caption="ลงวันที่" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy HH:mm:ss" AdaptivePriority="2" SettingsEditForm-Visible="False" />
        ...
        <dx:ContentControl ID="ContentControl1" runat="server">
            ...
            <dx:BootstrapFormLayout ID="BootstrapFormLayout4" runat="server" LayoutType="Horizontal">
                ...
                <Items>
                    ...
                    <dx:BootstrapLayoutItem Caption="เบี้ยประกันภัย" ColSpanMd="4" BeginRow="true">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="เบี้ยประกันภัยรวมอากร" ColSpanMd="4">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="ส่วนลด(%)" ColSpanMd="4">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="ส่วนลด(บาท)" ColSpanMd="4">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="เบี้ยนำส่งทั้งสิ้น" ColSpanMd="4">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="กำหนดรับชำระเงิน" ColSpanMd="4">
                        <ContentCollection>
                            <dx:ContentControl>
        ...
        <dx:ContentControl ID="ContentControl7" runat="server">
            ...
            <dx:BootstrapFormLayout ID="BootstrapFormLayout8" runat="server" LayoutType="Horizontal">
                ...
                <Items>
                    ...
                    <dx:BootstrapLayoutItem Caption="ส่วนลด" ColSpanMd="4" FieldName="BRCommAmt">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="ส่วนลด" ColSpanMd="4" FieldName="PRCommAmt">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="เบี้ยนำส่งทั้งสิ้น" ColSpanMd="4" FieldName="GrossPremium">
                        <ContentCollection>
                            <dx:ContentControl>
                    ...
                    <dx:BootstrapLayoutItem Caption="วันที่กำหนดรับชำระเงิน" ColSpanMd="4" FieldName="SentPolicyDate">
                        <ContentCollection>
                            <dx:ContentControl>
