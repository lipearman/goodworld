<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucBillingReceive.ascx.vb" Inherits="Modules_ucBillingReceive" %>
<style>
    legend {
        display: block;
        width: 100%;
...
<asp:SqlDataSource ID="SqlDataSource_BillingDetails" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    SelectCommand="select * from v_BillingDetails Order By CreateDate desc"
