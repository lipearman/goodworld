<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReportSubComPayment.ascx.vb" Inherits="Modules_ucReportSubComPayment" %>
...
<dx:BootstrapPopupControl ID="ReportPopup" ClientInstanceName="ReportPopup" runat="server" 
    ...
    <ContentCollection>
        <dx:ContentControl ID="ContentControl5" runat="server">
            ...
            <img src="images/ReportSubComPayment.jpg" width="850" />
        </dx:ContentControl>
    </ContentCollection>
