<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReportPayment2.ascx.vb" Inherits="Modules_ucReportPayment2" %>
...
<fieldset>
 ...
 <asp:SqlDataSource ID="SqlDataSource_Agent" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    SelectCommand="select distinct AgentCode,  convert(nvarchar(255),AgentName + ' (' + AgentCode + ')') as AgentName  from v_Report1  where PaymentDate is null order by AgentName ">
</asp:SqlDataSource>
...
<dx:BootstrapFormLayout ID="BootstrapFormLayout1" runat="server" ClientInstanceName="frmEnquiry" LayoutType="Horizontal">
    <Items>
            ...
            <ContentCollection>
                <dx:ContentControl>
                    <dx:BootstrapComboBox runat="server" ID="Agent"
                        DataSourceID="SqlDataSource_Agent" ValueField="AgentCode" TextField="AgentName"
