<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReportCMI.ascx.vb" Inherits="Modules_ucReportCMI" %>
...
<dx:BootstrapPopupControl ID="ReportPopup" ClientInstanceName="ReportPopup" runat="server" 
    ShowHeader="true" CloseOnEscape="false" CloseAction="CloseButton" HeaderText="รายงานประกันภัยภาคบังคับ"
    ...
    <ContentCollection>
        <dx:ContentControl ID="ContentControl5" runat="server">
            ...
            <img src="images/ReportCMI.jpg" width="850" />
        </dx:ContentControl>
    </ContentCollection>
