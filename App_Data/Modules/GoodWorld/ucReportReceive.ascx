<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReportReceive.ascx.vb" Inherits="Modules_ucReportReceive" %>
...
<dx:BootstrapGridView ID="TaskGrid" runat="server"
    ...
    <Columns>
              ...
              <dx:BootstrapGridViewTextColumn FieldName="ReceiveDate" Caption="วันที่รับเงิน" 
            PropertiesTextEdit-DisplayFormatString="{0:dd/MM/yyyy}" Width="100"
        ...
        <dx:BootstrapGridViewTextColumn FieldName="EffectiveDate" Caption="วันที่เริ่มคุ้มครอง"  Width="100"
