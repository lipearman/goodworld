<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReportPremiumPayment.ascx.vb" Inherits="Modules_ucReportPremiumPayment" %>
    ...
    <Items>
        ...
        <dx:BootstrapLayoutItem Caption="ถึงวันที่" ColSpanLg="4" ColSpanSm="6">
            <ContentCollection>
                ...
                <dx:BootstrapLayoutItem Caption="LotNo" ColSpanLg="4" ColSpanSm="6">
            <ContentCollection>
                <dx:ContentControl>
                   <dx:BootstrapTextBox runat="server" ID="LotNo"></dx:BootstrapTextBox>
                </dx:ContentControl>
            </ContentCollection>
        </dx:BootstrapLayoutItem>
...
<dx:BootstrapPopupControl ID="ReportPopup" ClientInstanceName="ReportPopup" runat="server" 
    ShowHeader="true" CloseOnEscape="false" CloseAction="CloseButton" HeaderText="รายงานการจ่ายค่าเบี้ยประกันภัย"
    ...
    <ContentCollection>
        <dx:ContentControl ID="ContentControl5" runat="server">
            ...
            <img src="images/ReportPremiumPayment.jpg" width="850" />
        </dx:ContentControl>
    </ContentCollection>
