<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReportForSubBroker.ascx.vb" Inherits="Modules_ucReportForSubBroker" %>
...
<dx:BootstrapPopupControl ID="ReportPopup" ClientInstanceName="ReportPopup" runat="server" 
    ...
    <ContentCollection>
        <dx:ContentControl ID="ContentControl5" runat="server">
            ...
            <img src="images/ReportSubBroker.jpg" width="850" />
        </dx:ContentControl>
    </ContentCollection>
